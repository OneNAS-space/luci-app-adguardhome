...
o.default = 0
o.optional = false
o = s:option(Value,"httpport",translate("WebUI management port"))
o.placeholder = 3008
o.default = 3008
o.datatype = "port"
o.optional = false
...
o.datatype = "string"
o.optional = true
o = s:option(Value, "hashpass", translate("Change WebUI management password"), translate("Press load calculate model and calculate finally save/apply"))
o.default = ""
o.datatype = "string"
